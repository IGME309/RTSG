...
Update: 2021/02
----------------------------------------------*/
#ifndef __SRTSYSTEM_H_
#define __SRTSYSTEM_H_
...
class BTXDLL SystemSingleton
{
	...
	String m_sWindowName = "STR - Window"; // Window Name
	String m_sAppName = "STR - Application";//Name of the Application
...
public:
	...
	*/
	...
	OUTPUT:
	*/
	float GetDeltaTime(uint a_nClock = 0);
