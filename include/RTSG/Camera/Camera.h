...
public:
	...
	*/
	...
	/*
	USAGE: Sets the view Matrix of the Camera
	ARGUMENTS: matrix4 a_m4View -> View matrix
	OUTPUT: ---
	*/
	void SetViewMatrix(matrix4 a_m4View);
	/*
	USAGE: Sets the target Projection Matrix of the Camera
	ARGUMENTS: matrix4 a_m4Projection -> Projection matrix
	OUTPUT: ---
	*/
	void SetProjectionMatrix(matrix4 a_m4Projection);
