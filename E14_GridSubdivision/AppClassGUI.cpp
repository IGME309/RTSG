...
void Application::DrawGUI(void)
{
	...
	//About
	{
		...
		RTSG::String sAbout = "System About";
		ImGui::Begin(sAbout.c_str(), (bool*)0, window_flags);
		{
			...
			ImGui::Text("	Arrow Keys: Move special cube");
			ImGui::Text("				(shift for Z axis)");
			ImGui::Text("	         [: Decrement Space");
			ImGui::Text("	         ]: Increment Space");
			ImGui::Text("	         -: Decrement Subdivisions");
			ImGui::Text("	         +: Increment subdivisions");
