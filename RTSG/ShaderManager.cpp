...
void ShaderManager::Init(void) 
{
	...
	CompileShader(pFolder->GetFolderShaders() + "RTSG.vs", pFolder->GetFolderShaders() + "Wireframe.fs", "Wireframe");
	...
	CompileShader(pFolder->GetFolderShaders() + "Minimal.vs", pFolder->GetFolderShaders() + "Minimal.fs", "Minimal");

	//Compile BasicColor shader
	CompileShader(pFolder->GetFolderShaders() + "BasicColor.vs", pFolder->GetFolderShaders() + "BasicColor.fs", "BasicColor");

	//Compile RTSG shader
	CompileShader(pFolder->GetFolderShaders() + "RTSG.vs", pFolder->GetFolderShaders() + "Simplex.fs", "RTSG");
