...
void SystemSingleton::SetWindowResolution(uint a_nResolution)
{
	...
	case eBTX_RESOLUTIONS::RES_S_600:
		m_nWindowWidth = 
			m_nWindowHeight = 600;
		break;
	case eBTX_RESOLUTIONS::RES_S_800:
		m_nWindowWidth =
			m_nWindowHeight = 800;
		break;
	case eBTX_RESOLUTIONS::RES_S_1080:
		m_nWindowWidth =
			m_nWindowHeight = 1080;
		break;
	case eBTX_RESOLUTIONS::RES_S_1280:
		m_nWindowWidth =
			m_nWindowHeight = 1280;
		break;
	default:
