...
void Application::InitVariables(void)
{
	...
	m_pModel = new RTSG::Model("Minecraft\\Steve.obj");
...
void Application::Display(void)
{
	...
	m_pCamera->SetTarget(vector3());//Setting the Target
	m_pCamera->SetUp(vector3(1.0f, 1.0f, 0.0f));//Setting what up means in the world
