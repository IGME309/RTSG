...
void Application::InitVariables(void)
{
	...
	//init the mesh
	m_pMesh = new Mesh();
	m_pMesh->GenerateCylinder(0.5f, 1.0f, 7, C_RED);
}
...
void Application::Display(void)
{
	...
	/*
	//extra part, how to rotate around a point (in this case the base of the cylinder)
	...
	*/
	...
	m_pModelMngr->AddSphereToRenderList(glm::scale(vector3(0.1f)), C_RED, RTSG::RENDER_WIRE);
