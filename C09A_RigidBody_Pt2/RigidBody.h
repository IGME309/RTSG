...
class RigidBody
{
	RTSG::ModelManager* m_pMeshMngr = nullptr; //for displaying the Rigid Body
...
#pragma region Accessors
	/*
	* The following are temporary Setters, they are only meant to be played
	* with for teaching purposes, in reality each Rigid Body will construct
	* itself
	*/
	void SetCenterGlobal(vector3 a_v3Input);
	void SetRadius(float a_fInput);
	void SetHalfWidth(vector3 a_v3Input);
	/*
