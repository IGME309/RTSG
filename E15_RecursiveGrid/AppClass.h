...
private:
	...
	RTSG::String m_sProgrammer = "Alberto Bobadilla - labigm@rit.edu";
	static ImGuiObject gui; //GUI object

	RTSG::uint m_uRenderCallCount = 0; //count of render calls per frame

	RTSG::vector3 m_v3Mouse = RTSG::vector3(); //position of the mouse in the window
	bool m_bFPC = false;// First Person Camera flag
	bool m_bArcBall = false;// Arcball flag
	RTSG::quaternion m_qArcBall; //ArcBall quaternion

	RTSG::vector4 m_v4ClearColor; //Color of the scene
	bool m_bRunning = false; //Is app running?

	sf::Window* m_pWindow = nullptr; //SFML window

	RTSG::SystemSingleton* m_pSystem = nullptr; //Singleton of the system
	RTSG::ModelManager* m_pModelMngr = nullptr; //Mesh Manager
	RTSG::CameraManager* m_pCameraMngr = nullptr; //Singleton for the camera manager
	RTSG::EntityManager* m_pEntityMngr = nullptr; //Singleton for the Entities
...
public:
	/*
	USAGE: Recalculates the current spaces subdivisions
	ARGUMENTS: ---
	OUTPUT: ---
	*/
...
#pragma region Constructor / Run / Destructor
	...
	*/
	...
	OUTPUT: ---
	*/
	void Init(RTSG::String a_sApplicationName = "", int a_uSize = RTSG::eBTX_RESOLUTIONS::RES_C_1280x720_16x9_HD,
	...
	OUTPUT: ---
	*/
	void Init(RTSG::String a_sApplicationName, RTSG::uint a_uWidth, RTSG::uint a_uHeight, bool a_bFullscreen, bool a_bBorderless);
...
#pragma region Initialization / Release
	...
	OUTPUT: ---
	*/
	void InitWindow(RTSG::String a_sWindowName = "Application");
...
#pragma region Main Loop
	...
	*/
	...
	OUTPUT: ---
	*/
	void ClearScreen(RTSG::vector4 a_v4ClearColor = RTSG::vector4(-1.0f));
#pragma endregion

#pragma region Application Controls
	/*
	USAGE: Returns the Arcball in a matrix 4 form
	ARGUMENTS: ---
	OUTPUT: orientation of the Arcball
	*/
	matrix4 OrientByArcball(void);
