...
public:
	...
	*/
	...
	ARGUMENTS: float a_fRadians = 0.01f -> degree of rotation
	OUTPUT: ---
	*/
	void ChangePitch(float a_fRadians = 0.001f);
	...
	OUTPUT: ---
	*/
	void ChangeYaw(float a_fRadians = 0.001f);
	...
	OUTPUT: ---
	*/
	void ChangeRoll(float a_fRadians = 0.001f);
