...
void Application::ProcessKeyPressed(sf::Event a_event)
{
	...
	case sf::Keyboard::Space:
		m_fTimer += m_pSystem->GetDeltaTime() * 3.0f;
		break;
	}
	//gui
...
void Application::ProcessKeyReleased(sf::Event a_event)
{
	...
	case sf::Keyboard::F:
		...
		break;
	case sf::Keyboard::P:
		RTSG::TextureManager::SaveScreenshot(m_pSystem->GetAppName());
		break;
	...
	case sf::Keyboard::Subtract:
		...
		break;
	case sf::Keyboard::Space:
		m_pEntityMngr->ApplyForce(m_v3Force * m_fTimer, "Steve");
		m_fTimer = 0.0f;
		break;
	case sf::Keyboard::R:
		m_v3Start = vector3(-5.0f, 0.0f, 0.0f);
		m_v3Force = vector3(1.0f, 0.0f, 0.0f);
		m_fTimer = 0.0f;
		m_pEntityMngr->SetModelMatrix(glm::translate(m_v3Start), "Steve");
		m_pEntityMngr->SetModelMatrix(glm::translate(vector3()), "Cube");
		break;
	case sf::Keyboard::LShift:
	case sf::Keyboard::RShift:
		m_bModifier = false;
