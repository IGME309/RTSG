...
void Application::Update(void)
{
	...
	static float fDelta = 0.01f; //reason of change for the displacement
	static vector3 start(-1.0f, 0.0f, 0.0f); //starting point
	...
	//Once we reach 1 (or 100%) we change direction
	if (progress >= 1.0f)
	{
		//TODO: make it so the triangle bounces from right to left and then left to right
	}
