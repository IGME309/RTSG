...
class Application
{
	RTSG::Model* m_pSteve = nullptr;
	RTSG::Model* m_pCreeper = nullptr;
	Camera* m_pCamera = nullptr; //camera we will use in this application
private:
...
#pragma region Constructor / Run / Destructor
	...
	*/
	...
	OUTPUT: ---
	*/
	void Init(String a_sApplicationName = "", int a_uSize = RTSG::eBTX_RESOLUTIONS::RES_C_1280x720_16x9_HD,
